...
outprefix = "covid-artic-v5.2.0_1200"
bed_url = "https://raw.githubusercontent.com/pha4ge/primer-schemes/main/sars-cov-2/artic/v5.2.0_1200/primer.bed"
...
with open(bed_file) as f_in, open(f"../{outprefix}.vwf.tsv", "w") as f_out:
    print("Amplicon_name",
        "Primer_name",
        "Left_or_right",
        "Sequence",
    ...
    for line in f_in:
        ...
        amplicon_name, number, l_or_r = primer_name.rsplit("_", maxsplit=2)
